    ...
    <v-layout row wrap>
      <v-flex xs12>
       <h1>Bead Etsy</h1>
        ...
        <h1 class="mt-4">Bead Projects</h1>
        
        <v-card v-for="magazine in magazines" v-if="magazine.project" :key="magazine.id">
          <v-container fluid>
            <v-layout row>
              <v-flex xs3 sm2 md1>
                <v-card-media
              ...
              <v-flex xs6 sm8 md9>
                <v-card-title primary-title class="pt-0 pb-0">
                  <div>
                    <h3>{{ magazine.product_title }} <span v-if="magazine.premium" style="color: red;"> - Premium</span></h3>
                    <div>{{ magazine.product_desc }}</div>
